...
_MENU = (
    (
        ...
        "Jugos y Extractos",
        6500,
        "Naranja, piña, pepino, apio y nopal.",
        ("INS-NAR", "INS-PIN", "INS-PEP", "INS-API", "INS-NOP"),
    ),
    (
        "Jugo Relajante",
        "JUG-REL",
        "Jugos y Extractos",
        6500,
        "Naranja, papaya y avena.",
        ("INS-NAR", "INS-PAP", "INS-AVE"),
    ),
    (
        "Jugo Vitamínico",
        "JUG-VIT",
        "Jugos y Extractos",
        6500,
        "Naranja, fresa, manzana y pepino.",
        ("INS-NAR", "INS-FRE", "INS-MAN", "INS-PEP"),
    ),
    (
        "Jugo Energetizante",
        "JUG-ENE",
    ...
    (
        ...
        "Jugos y Extractos",
        6500,
        "Naranja, zanahoria y betabel.",
        ("INS-NAR", "INS-ZAN", "INS-BET"),
    ),
    (
        "Extracto Verde",
        "EXT-VER",
        ...
        ("INS-PEP", "INS-API", "INS-ESP", "INS-LIM", "INS-MAN"),
    ),
    (
        "Extracto Rojo",
        "EXT-ROJ",
        "Jugos y Extractos",
        6300,
        "Fresco sabor del pepino con apio, betabel, jugo de limón y dulce de la manzana roja.",
        ("INS-PEP", "INS-API", "INS-BET", "INS-LIM", "INS-MAN"),
    ),
    (
        "Shot Jengibre-Piña",
        "SHO-JEN",
        "Jugos y Extractos",
        4000,
        "Energizante mezcla de extracto de jengibre y rico jugo de piña.",
        ("INS-JEN", "INS-PIN"),
    ),
    ...
    (
        ...
        9000,
        "Manzana, leche de almendra, miel de abeja, dátil, chía y espinaca.",
        ("INS-MAN", "INS-LEC-ALM", "INS-MIE", "INS-DAT", "INS-CHI", "INS-ESP"),
    ),
    (
        "Smoothie Rosa",
        "SMO-ROS",
        "Smoothies y Licuados",
        9000,
        "Fresa con leche de almendra, miel de abeja, dátil, chía y espinaca.",
        ("INS-FRE", "INS-LEC-ALM", "INS-MIE", "INS-DAT", "INS-CHI", "INS-ESP"),
    ),
    (
        "Smoothie Cacao",
        "SMO-CAC",
        "Smoothies y Licuados",
        9000,
        "Plátano, leche de almendra, miel de abeja, cacao, chía y espinaca.",
        ("INS-PLA", "INS-LEC-ALM", "INS-MIE", "INS-CAC-POL", "INS-CHI", "INS-ESP"),
    ),
    (
        "Smoothie Pro",
        "SMO-PRO",
        "Smoothies y Licuados",
        12000,
        "Smoothie Fresh, Rosa o Cacao con scoop de proteína.",
        ("INS-PROT", "INS-LEC-ALM"),
    ),
    ("Bisquet", "PAN-BIS", "Panadería", 3500, "", ()),
    ("Baguette", "PAN-BAG", "Panadería", 2600, "", ("INS-PAN-BAG",)),
    (
        "Cuernito Jamón/Phila",
        "PAN-CUE",
        "Panadería",
        3800,
        "Relleno de jamón y philadelphia.",
        ("INS-PAN-CUE", "INS-JAM", "INS-PHI"),
    ),
    ("Barra de pan sándwich", "PAN-BAR", "Panadería", 6000, "", ("INS-PAN-SAN",)),
    (
        "Ensalada Manzana Nuez",
        "ENS-MAN",
        "Ensaladas",
        12000,
        "Lechuga, queso de cabra, nuez, dulces cubitos de manzana, ajonjolí y aderezo balsámico.",
        ("INS-LEC-ENT", "INS-QUE-CAB", "INS-NUE", "INS-MAN", "INS-AJO", "INS-ADE-BAL"),
    ),
    (
        ...
        "Ensaladas",
        12500,
        "Lechuga, fresa, arándanos, queso panela, cacahuates garapiñados y aderezo balsámico.",
        ("INS-LEC-ENT", "INS-FRE", "INS-QUE-PAN", "INS-CAC", "INS-ADE-BAL"),
    ),
    (
        "Ensalada Del Chef",
        "ENS-CHE",
        "Ensaladas",
        12500,
        "Lechuga, pollo a la plancha, pepino, jamón, panela, tostaditas, germinado, gajos de tomate, cebolla, aderezo.",
        (
            "INS-LEC-ENT",
            "INS-POL-PLA",
            "INS-PEP",
    ...
    (
        ...
        11500,
        "Con Cuernito, Baguette o Focaccia.",
        ("INS-PAN-CUE", "INS-POL-PLA"),
    ),
    (
        "Sando Kyoto Pollo BBQ",
        "SAN-KYO-BBQ",
        "Emparedados y Sandos",
        12000,
        "Sandwich tipo Sando relleno.",
        ("INS-PAN-SAN", "INS-POL-BBQ"),
    ),
    (
        "Combo Ligero",
        "COM-LIG",
        "Combos",
        10500,
        "Sándwich básico + fresco jugo de naranja del día + dulce galleta con chispas.",
        ("INS-PAN-SAN", "INS-JAM", "INS-QUE-PAN", "INS-NAR", "INS-GAL-CHI"),
    ),
    (
        "Combo Premium",
        "COM-PRE",
        ...
        ("INS-LEC-ENT", "INS-PAN-BAG", "INS-POL-PLA"),
    ),
)
_BRANCH_NAMES = (
    "Centro Histórico",
...
def kiwi_v1_manifest() -> dict[str, Any]:
    ...
    branches = [
        {
            "id": f"branch-{position:02d}",
            "legal_entity_id": "legal-kiwi-v1",
            "business_unit_id": "unit-kiwi-v1",
            "name": name,
            "code": f"BR-{position:03d}",
    ...
    return {
        ...
        "operations": [
            ...
            },
            {
                ...
                "branch_id": "branch-01",
                "categories": [
                    {"id": category_ids[name], "name": name, "display_order": position}
                    for name, position in _CATEGORIES
                ],
                "units": [
                    {
                        "id": _id("unit", code),
                    ...
                    for code, name, precision in _UNITS
                ],
                "items": [
                    {
                        "id": _id("item", sku),
                        "name": name,
                        "sku": sku,
                        "base_unit_id": _id("unit", unit),
                        "item_type": "ingredient",
                    }
                    for name, sku, unit in _ITEMS
                ],
                "products": [
                    {
                        "id": _id("product", sku),
                        ...
                        "recipe": {
                            ...
                            "components": [
                                {
                                    "item_id": _id("item", item_sku),
                                    "unit_id": _id("unit", item_units[item_sku]),
