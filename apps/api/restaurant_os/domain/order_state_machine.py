...
class OrderStateMachine:
    ...
    VALID_TRANSITIONS: dict[OrderState, set[OrderState]] = {
        OrderState.DRAFT: {OrderState.ACCEPTED, OrderState.CANCELLED, OrderState.REJECTED},
        OrderState.ACCEPTED: {OrderState.SENT_TO_PRODUCTION, OrderState.CANCELLED},
        OrderState.SENT_TO_PRODUCTION: {
            OrderState.IN_PRODUCTION,
            OrderState.CANCELLED,
            OrderState.FAILED,
        },
        OrderState.IN_PRODUCTION: {OrderState.READY, OrderState.CANCELLED},
        OrderState.READY: {
        ...
        OrderState.DELIVERED: {OrderState.CLOSED, OrderState.RETURNED},
