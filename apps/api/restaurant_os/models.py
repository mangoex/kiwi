...
catalog_product_configuration_commands = sa.Table(
...
offline_order_bundles = sa.Table(
...
offline_order_gateway_leases = sa.Table(
...
offline_order_handoffs = sa.Table(
