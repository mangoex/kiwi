...
| PRD-FR-209 | POS-only navigation, inventory under Administration and five operational catalog groups with eligible category cards and local favorites | BDD-SC-236, BDD-SC-237, BDD-SC-238 | TDD-TS-070, TDD-TC-066 | Implementado |
