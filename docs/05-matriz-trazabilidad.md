...
| PRD-FR-213 | Required single-select category option before concrete POS product, explicit editable assignment, integrated Group/Subgroup administration, branch projection, corporate catalog.manage administration and fail-closed incomplete coverage | BDD-SC-255, BDD-SC-256, BDD-SC-257, BDD-SC-258, BDD-SC-259, BDD-SC-260, BDD-SC-261, BDD-SC-262, BDD-SC-263, BDD-SC-511, BDD-SC-512, BDD-SC-513 | TDD-TS-075, TDD-TC-071, TDD-TS-114, TDD-TC-257 | Implementado |
