...
| PRD-FR-232 | SDD §5.12: Hub de Integraciones desacoplado, configuración segura y adaptador Uber Eats con validación HMAC e idempotencia | BDD-SC-459, BDD-SC-460, BDD-SC-461, BDD-SC-462, BDD-SC-463, BDD-SC-464 | TDD-TS-103, TDD-TC-221, TDD-TC-222, TDD-TC-223, TDD-TC-224 | Implementado |
| PRD-FR-233 | SDD §5.12: Monitor y gestión de pedidos Uber Eats en terminal POS con control de estados y despacho | BDD-SC-465 | TDD-TS-103, TDD-TC-225 | Implementado |
