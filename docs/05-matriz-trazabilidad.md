...
| PRD-FR-005 | RBAC scoped authorization | BDD-SC-021, BDD-SC-025, BDD-SC-043, BDD-SC-044, BDD-SC-045, BDD-SC-057, BDD-SC-058, BDD-SC-059, BDD-SC-060, BDD-SC-061, BDD-SC-063, BDD-SC-064, BDD-SC-065, BDD-SC-066, BDD-SC-067, BDD-SC-068, BDD-SC-118, BDD-SC-119, BDD-SC-123, BDD-SC-125, BDD-SC-126, BDD-SC-127, BDD-SC-132, BDD-SC-133, BDD-SC-136, BDD-SC-137, BDD-SC-141, BDD-SC-143, BDD-SC-193 | TDD-TS-012, TDD-TS-014, TDD-TS-025, TDD-TS-034, TDD-TS-035, TDD-TS-036, TDD-TS-037, TDD-TS-038, TDD-TS-050, TDD-TS-051, TDD-TS-052, TDD-TS-060, TDD-TC-031, TDD-TC-043, TDD-TC-044, TDD-TC-045, TDD-TC-055 | Scaffold |
...
| PRD-FR-205 | Supervisor-authorized courtesy adjustments; auditoría 2026-08-19 detectó UI simulada sin autoridad backend | BDD-SC-218, BDD-SC-219, BDD-SC-220, BDD-SC-221, BDD-SC-222, BDD-SC-361, BDD-SC-362 | TDD-TS-065, TDD-TC-060, TDD-TS-090, TDD-TC-146, TDD-TC-147 | Scaffold |
| PRD-FR-206 | Branch-originated supplier creation; contrato/permiso/atomicidad requieren reparación | BDD-SC-223, BDD-SC-224, BDD-SC-225, BDD-SC-228, BDD-SC-363, BDD-SC-364 | TDD-TS-066, TDD-TC-061, TDD-TS-090, TDD-TC-148 | Scaffold |
| PRD-FR-207 | Branch multi-line direct purchases; core parcial sin cobertura suficiente de alcance/cancelación | BDD-SC-226, BDD-SC-227, BDD-SC-228, BDD-SC-229, BDD-SC-365, BDD-SC-366 | TDD-TS-067, TDD-TC-062, TDD-TS-090, TDD-TC-149, TDD-TC-150 | Scaffold |
...
| PRD-FR-221 | SDD §39.1/39.3, ADR-030 aprobada: rutas operacionales default-deny; KDS con permiso dedicado; replay sync device-scoped y descarga branch-scoped; seed interno versionado para organización/topología/catálogo sin DDL en dry-run; scanner de fuentes, claves y artefactos SQLite/SQL | BDD-SC-355, BDD-SC-356, BDD-SC-357, BDD-SC-358 | TDD-TS-089, TDD-TC-141, TDD-TC-142, TDD-TC-143, TDD-TC-145 | Implementado |
...
| PRD-NFR-026 | SDD §39.1: política de repositorio, fixtures sintéticos y contención separada | BDD-SC-358 | TDD-TS-089, TDD-TC-145 | Disenado |
