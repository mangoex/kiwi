...
| PRD-FR-216 | PCO-002: versioned corporate cash concepts, idempotent management and backend-effective reads; PCO-003 retains append-only deposits/withdrawals and expected-cash calculation | BDD-SC-278, BDD-SC-279, BDD-SC-280, BDD-SC-289, BDD-SC-294, BDD-SC-296, BDD-SC-301 | TDD-TS-078, TDD-TC-074, TDD-TC-079, TDD-TS-083, TDD-TC-084 | Implementado |
