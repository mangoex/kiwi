...
| PRD-FR-217 | Account consultation with snapshots and governed reopen request; PCO-005A request/decision is non-mutating and application remains PCO-005B | BDD-SC-281, BDD-SC-282, BDD-SC-283, BDD-SC-312, BDD-SC-313, BDD-SC-314, BDD-SC-315, BDD-SC-316 | TDD-TS-079, TDD-TC-075, TDD-TC-096, TDD-TC-097, TDD-TC-098, TDD-TC-099, TDD-TC-100 | Disenado |
