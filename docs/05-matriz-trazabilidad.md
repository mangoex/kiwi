...
| PRD-NFR-024 | PCO-001/006 conservan historia; 0058 contiene 0049 sin reconstrucción automática y deja la reconciliación ambigua a decisión humana; oráculo focal PostgreSQL 16 verde y CI del PR #56 observado, con Dependency Review bloqueado por configuración del repositorio | BDD-SC-290, BDD-SC-334, BDD-SC-400, BDD-SC-454 | TDD-TS-084, TDD-TS-087, TDD-TC-120, TDD-TC-178, TDD-TC-211, TDD-TC-215 | Probado |
