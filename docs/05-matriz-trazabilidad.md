...
| PRD-FR-221 | SDD §39.1, ADR-030 propuesta: rutas operacionales default-deny y seeds internos | BDD-SC-355, BDD-SC-356, BDD-SC-357 | TDD-TS-089, TDD-TC-141, TDD-TC-142, TDD-TC-143 | Disenado |
| PRD-FR-222 | SDD §39.1/39.3: pull por dispositivo, intento/acuse/fallo autoritativos | BDD-SC-359, BDD-SC-360, BDD-SC-367 | TDD-TS-089, TDD-TC-144, TDD-TS-090, TDD-TC-151 | Disenado |
