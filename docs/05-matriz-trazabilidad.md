...
| PRD-FR-216 | PCO-002 concepts plus authorized PCO-003 append-only deposits/withdrawals, exact compensation, purchase linkage and Python expected-cash; offline remains PCO-008 | BDD-SC-278, BDD-SC-279, BDD-SC-280, BDD-SC-289, BDD-SC-294, BDD-SC-296, BDD-SC-301, BDD-SC-302, BDD-SC-303, BDD-SC-304, BDD-SC-305 | TDD-TS-078, TDD-TC-074, TDD-TC-079, TDD-TS-083, TDD-TC-084, TDD-TC-085, TDD-TC-086, TDD-TC-087, TDD-TC-088 | Implementado |
