...
| PRD-FR-214 | Icon-only product presentation in POS grid and cart regardless of image_url; category preselector preserves current behavior | BDD-SC-265, BDD-SC-266, BDD-SC-267, BDD-SC-268, BDD-SC-269 | TDD-TS-076, TDD-TC-072 | Implementado |
