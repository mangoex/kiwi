...
| PRD-FR-221 | SDD §39.1/39.3, ADR-030 aprobada: rutas operacionales default-deny; KDS con permiso dedicado; sync/credenciales por scope persistido; seed interno sin DDL en dry-run; scanner de fuentes, claves y artefactos SQLite/SQL | BDD-SC-355, BDD-SC-356, BDD-SC-357, BDD-SC-358 | TDD-TS-089, TDD-TC-141, TDD-TC-142, TDD-TC-143, TDD-TC-145 | Implementado |
