...
| PRD-FR-204 | Pedidos detail, selected-order edit routing and versioned amendment of unpaid orders | BDD-SC-214, BDD-SC-215, BDD-SC-216, BDD-SC-217, BDD-SC-235, BDD-SC-248 | TDD-TS-064, TDD-TC-059, TDD-TS-069, TDD-TS-073, TDD-TC-069 | Implementado |
