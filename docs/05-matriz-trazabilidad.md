...
| PRD-FR-010 | Catalog module; SDD §46.4 para composición fija de combos | BDD-SC-026, BDD-SC-027, BDD-SC-048, BDD-SC-056, BDD-SC-058, BDD-SC-488, BDD-SC-498, BDD-SC-499, BDD-SC-500, BDD-SC-501, BDD-SC-515 | TDD-TS-015, TDD-TS-016, TDD-TS-027, TDD-TS-033, TDD-TS-035, TDD-TS-108, TDD-TC-241, TDD-TS-112, TDD-TC-246, TDD-TC-247, TDD-TC-248 | Scaffold |
...
| PRD-FR-213 | Required single-select category option before concrete POS product, explicit editable assignment, integrated Group/Subgroup administration with Python-owned technical defaults, branch projection, corporate catalog.manage administration and fail-closed incomplete coverage | BDD-SC-255, BDD-SC-256, BDD-SC-257, BDD-SC-258, BDD-SC-259, BDD-SC-260, BDD-SC-261, BDD-SC-262, BDD-SC-263, BDD-SC-511, BDD-SC-512, BDD-SC-513, BDD-SC-516 | TDD-TS-075, TDD-TC-071, TDD-TS-114, TDD-TC-257 | Implementado |
