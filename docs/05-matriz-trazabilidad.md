...
| PRD-FR-223 | SDD §39.2, ADR-031: intención pública canónica e idempotente con validación telefónica E.164 | BDD-SC-368, BDD-SC-369, BDD-SC-370, BDD-SC-371, BDD-SC-372, BDD-SC-376 | TDD-TS-091, TDD-TC-152, TDD-TC-153, TDD-TC-154, TDD-TC-155 | Implementado |
| PRD-FR-224 | SDD §39.2/39.3: aceptación autenticada por dominio compartido, reserva de inventario atómica, sin turno público fantasma | BDD-SC-373, BDD-SC-374, BDD-SC-375 | TDD-TS-091, TDD-TC-156, TDD-TC-157 | Implementado |
