...
- `PRD-FR-222`: Debe permitir a Administradores corporativos y Dueño consultar el consolidado multi-sucursal
...
- `PRD-FR-223`: Debe proveer una interfaz web responsiva de autoservicio para clientes móviles
