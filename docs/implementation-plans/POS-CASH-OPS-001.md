...
| PCO-005B | FR-217, NFR-025, SC-317..326, TC-101..112 | corrección enlazada, ajustes de pago/inventario/producción y UI Dueño | PCO-005A y ADR-027 aprobada | `APPROVED -> APPLIED` atómico sin reescribir cuenta/pago/corte original; implementación/auditoría pendientes |
