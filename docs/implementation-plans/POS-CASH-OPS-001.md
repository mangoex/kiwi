...
| PCO-005B | FR-217, NFR-025, SC-317..326, TC-101..112 | corrección enlazada, ajustes de pago/inventario/producción y UI Dueño | PCO-005A y ADR-027 aprobada | `APPROVED -> APPLIED` atómico implementado sin reescribir cuenta/pago/corte original |
| PCO-006 | FR-219, SC-286/287/295/327..334, TS-081/TC-113..120 | cortes, locks, historial y reapertura compensatoria | Decisión 014/017, PCO-004 | cajero/periodo/fórmula/concurrencia/solape/rollback RED; snapshot y asociación histórica única GREEN |
