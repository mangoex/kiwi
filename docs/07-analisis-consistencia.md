...
| CONS-015 | Omisión en cierre incremental | Alta | `PRD-FR-052` existe; PCO-002 implementa el catálogo efectivo, pero el comando POS genérico de depósito/retiro permanece reservado a PCO-003. | Caja todavía no refleja movimientos manuales hasta cerrar el ledger. | Mantener PCO-002 sin escrituras financieras y exigir RED de fórmula/idempotencia/compensación antes de PCO-003. |
