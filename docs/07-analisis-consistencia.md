...
| CONS-013 | Contradiccion resuelta | Crítica | `PRD-FR-204` conserva de sólo lectura pedidos pagados o con producción iniciada, mientras el video menciona reabrir cuenta. | Podría alterar pagos, producción, inventario y corte históricos. | `OPEN-013A/B` y `SDD-ADR-027` resueltos: Cajero jefe+ solicita, Dueño decide y PCO-005B aplica una corrección enlazada/compensatoria sin reescribir la cuenta original. |
