...
| CONS-013 | Contradiccion resuelta | Crítica | `PRD-FR-204` conserva de sólo lectura pedidos pagados o con producción iniciada, mientras el video menciona reabrir cuenta. | Podría alterar pagos, producción, inventario y corte históricos. | `OPEN-013A/B` resueltos: Cajero jefe+ solicita, Dueño autoriza y aplicación compensatoria/auditable en PCO-005; PCO-001 no habilita rutas. |
| CONS-014 | Riesgo | Alta | UI actual cierra turno con `counted_cash_cents=0` y backend combina cierre con corte. | Genera diferencias ficticias y borra separación operativa/financiera. | Diseñar cierre operativo separado y corte con efectivo contado; no declarar solución implementada. |
| CONS-015 | Omisión | Alta | `PRD-FR-052` existe, movimientos siguen Diseñado y no hay comando POS genérico de depósito/retiro manual. | Caja no puede reflejar los movimientos confirmados por el video. | POS-CASH-OPS propone ledger, conceptos, compensación, offline e idempotencia; implementar sólo después de gates. |
